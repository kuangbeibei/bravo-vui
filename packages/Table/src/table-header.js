                ...
                <tr>
                    {
                        columns.map((column, idx) => {
                            return <th>{
                                this.expo && idx === columns.length - 1 ?  this.renderFirstHeaderCell(column) :
